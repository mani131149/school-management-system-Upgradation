      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>My Son's Fee Payment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="student_payment.php"><i class="fa fa-circle-o"></i> Fee Payment</a></li>
            <li><a href="my_sons_payments.php"><i class="fa fa-circle-o"></i> Payment History</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
